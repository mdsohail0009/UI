export default {
	...
	your_portfolio: 'Crypto Currency Balances',
  ...
  address_hint_text:"Be sure to select the right cryptocurrency. If you send crypto to the wrong address (eg, Bitcoin to a Bitcoin Cash address), your crypto will be lost.",
	copy: "Copy",
	share: "Share",
  ...
  reference_hint_text:"Important: This code identifies your deposits. Please include the reference code when submitting the wire transfer in either the transaction description or purpose",
  ...
  desposite_text:"Please select the currency you would like to deposit in. The bank account details for the specific currency will then be shown. You are then required to wire the funds over to the provided bank details.",
  ...
  final_Amount: 'Output is estimated. Final amount will vary due to market conditions.',
	...
	//agree_terms: 'Please agree terms of service',
  agree_terms:'Please click the checkbox above after reading and agreeing to the Terms of Service before proceeding',
	All: "All",
	BuyandSell: "Buy/Sell",
  ...
  account_details:"Please ensure that the above details are accurate and correct as the transaction is irreversible",
  ...
  agree_termsofservice:'Please click the checkbox above after reading and agreeing to the Terms of Service before proceeding',
  ...
  accept_terms:'Please click the checkbox above after reading and agreeing to the Terms of Service before proceeding',
