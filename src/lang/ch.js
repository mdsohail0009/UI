export default {
  ...
  address_hint_text:'請務必選擇正確的加密貨幣。 如果您將加密貨幣發送到錯誤的地址（例如，將比特幣發送到比特幣現金地址），您的加密貨幣將會丟失。',
	copy: "复制",
	share: "分享",
	from_crypto: "来自加密",
	from_fiat: "来自菲亚特",
	...
	reference: "参考",
	// reference_hint_text:
	// 	"重要提示：此代码可识别您的存款，请在交易说明或目的中提交电汇时包含此代码",
  reference_hint_text:"重要提示：此代碼可識別您的存款。 請在提交電匯時在交易描述或目的中包含參考代碼",
  //desposite_text: '请选择您要存入的货币，然后将显示所选货币的银行帐户详细信息。下一步是您将资金电汇到所提供的银行详细信息，并记住包括参考号。',
  desposite_text:"請選擇您要存入的貨幣。然後將顯示特定貨幣的銀行賬戶詳細信息。 然後，您需要將資金電匯到提供的銀行詳細信息。",
	EUR_amount: "欧元金额",
	Fee: "费用",
	Amount_to_pay: "支付数量",
	place_an_order: "下订单",
 ...
 //	agree_terms: "請同意條款和條件",
  ...
  account_details:"請確保以上資料準確無誤，交易不可撤銷",
	account_details: "確保帳戶詳細信息正確無誤",
