export default {
  ...
  searchCurrency:'搜索貨幣',
  selectWallet:'選擇錢包',
  final_Amount:'您的最終金額可能會更改為 10 秒。',
  ...
  Enabled:'啟用',
  Disabled:'已禁用',
  Choose_a_unique_password_to_protect_your_account:'選擇一個唯一的密碼來保護您的帳戶',
  Password:'密碼',
  Modifiedon:'修改於',
  Click_here_to_change_password:'單擊此處更改密碼',
  current_password:'當前密碼',
  change_password:'更改密碼',
  Type_your_current_password:'輸入你當前的密碼',
  Type_your_new_password:'輸入您的新密碼',
  Re_type_your_new_password:'重新輸入您的新密碼',
  new_password:'新密碼',
