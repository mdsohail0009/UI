export default {
  ...
  current_password_msg:'Mangyaring ipasok ang kasalukuyang password',
  new_password_msg:'Kailangan ng bagong password',
  confirm_password_msg:'Mangyaring ipasok ang kumpirmahin ang password',
