export default {
  ...
  Coin:'barya',
  Enteraddresslabel:'Ilagay ang label ng address',
  ...
  wallet_address:'Pumili ng wallet address',
  ...
  tag:'Tag',
  button:'Ibahagi',
  select_address:'Piliin ang Address Book',
  searchAddress:'Maghanap ng label ng address',
  oops:'OOPS',
  address_available:'Walang available na address',
  withdrawSummary:'Bawiin ang Buod',
  ...
  Choose_a_unique_password_to_protect_your_account:'Pumili ng isang natatanging password upang protektahan ang iyong account',
  Password:'Password',
  Modifiedon:'Binago noong',
  Click_here_to_change_password:'Mag-click dito upang baguhin ang password',
  current_password:'Kasalukuyang Password',
  change_password:'PALITAN ANG PASSWORD',
  Type_your_current_password:'I-type ang iyong kasalukuyang password',
  Type_your_new_password:'I-type ang iyong bagong password',
  Re_type_your_new_password:'I-type muli ang iyong bagong password',
  ...
  coin_swap:'Mangyaring pumili mula sa barya upang ipagpalit',
  ...
  current_password:'Mangyaring ipasok ang kasalukuyang password',
