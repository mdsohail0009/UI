export default {
  ...
  address_hint_text:'Siguraduhing piliin ang tamang cryptocurrency. Kung nagpadala ka ng crypto sa maling address (hal., Bitcoin sa isang Bitcoin Cash address), mawawala ang iyong crypto.',
  copy: 'Salinan',
  share: 'Berkongsi',
  ...
  reference_hint_text:"Mahalaga: Tinutukoy ng code na ito ang iyong mga deposito. Pakisama ang reference code kapag isinusumite ang wire transfer sa alinman sa paglalarawan o layunin ng transaksyon",
  ...
  desposite_text:"Mangyaring piliin ang pera na gusto mong i-deposito. Ang mga detalye ng bank account para sa partikular na pera ay ipapakita. Pagkatapos ay kinakailangan mong i-wire ang mga pondo sa ibinigay na mga detalye ng bangko.",
  ...
  account_details:"Pakitiyak na tumpak at tama ang mga detalye sa itaas dahil hindi na mababawi ang transaksyon",
  ...
  wallet_address:"Mag-withdraw sa iyong naka-whitelist na cryptocurrency wallet.",
  ...
  agree_termsofservice:'Paki-click ang checkbox sa itaas pagkatapos basahin at sumang-ayon sa Mga Tuntunin ng Serbisyo bago magpatuloy',
  ...
  accept_terms:'Paki-click ang checkbox sa itaas pagkatapos basahin at sumang-ayon sa Mga Tuntunin ng Serbisyo bago magpatuloy',
