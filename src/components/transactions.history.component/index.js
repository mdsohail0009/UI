...
class TransactionsHistory extends Component {
	...
	state = {
		...
		WithdrawCryptoURL:
			process.env.REACT_APP_GRID_API + "Withdraw/Accounts/Crypto",
		DepositCryptoURL:
			process.env.REACT_APP_GRID_API + "Deposits/Accounts/Crypto",
		activeTab: "1",
		cryptoModal: false,
		selectedModal: "",
	};
	...
	addressbookTrack = () => {
		if (this.state.activeTab == "1") {
			apiCalls.trackEvent({
				Type: "User",
				Action: "Transactions Buy/Sell page view",
				Username: this.props.member?.userName,
				MemeberId: this.props.member?.id,
				Feature: "Transactions",
				Remarks: "Transactions Buy/Sell grid view",
				Duration: 1,
				Url: window.location.href,
				FullFeatureName: "Transactions",
			});
			...
			apiCalls.trackEvent({
				Type: "User",
				Action: "Transactions Swap page view",
				Username: this.props.member?.userName,
				MemeberId: this.props.member?.id,
				Feature: "Transactions",
				Remarks: "Transactions Swap grid view",
				Duration: 1,
				Url: window.location.href,
				FullFeatureName: "Transactions",
			});
			...
			apiCalls.trackEvent({
				Type: "User",
				Action: "Transactions Deposit Fiat page view",
				Username: this.props.member?.userName,
				MemeberId: this.props.member?.id,
				Feature: "Transactions",
				Remarks: "Transactions Deposit Fiat grid view",
				Duration: 1,
				Url: window.location.href,
				FullFeatureName: "Transactions",
			});
			...
			apiCalls.trackEvent({
				Type: "User",
				Action: "Transactions Deposit Crypto page view",
				Username: this.props.member?.userName,
				MemeberId: this.props.member?.id,
				Feature: "Transactions",
				Remarks: "Transactions Deposit Crypto grid view",
				Duration: 1,
				Url: window.location.href,
				FullFeatureName: "Transactions",
			});
			...
			apiCalls.trackEvent({
				Type: "User",
				Action: "Transactions Withdraw Fiat page view",
				Username: this.props.member?.userName,
				MemeberId: this.props.member?.id,
				Feature: "Transactions",
				Remarks: "Transactions Withdraw Fiat grid view",
				Duration: 1,
				Url: window.location.href,
				FullFeatureName: "Transactions",
			});
			...
			apiCalls.trackEvent({
				Type: "User",
				Action: "Transactions Withdraw Crypto page view",
				Username: this.props.member?.userName,
				MemeberId: this.props.member?.id,
				Feature: "Transactions",
				Remarks: "Transactions Withdraw Crypto grid view",
				Duration: 1,
				Url: window.location.href,
				FullFeatureName: "Transactions",
			});
	...
	withdrawcolumns = [
		{
			field: "accountType",
			title: apiCalls.convertLocalLang("accountType"),
			filter: true,
			width: 200,
		},
		{
			field: "walletCode",
			title: apiCalls.convertLocalLang("Wallet"),
			filter: true,
			width: 200,
		},
		{
			field: "amount",
			title: apiCalls.convertLocalLang("amount"),
			filter: true,
			width: 220,
			dataType: "number",
			filterType: "numeric",
		...
		{
			field: "createdDate",
			title: apiCalls.convertLocalLang("RequestDate"),
			filter: true,
			width: 210,
			footerCell: true,
			filterType: "date",
		...
		{
			field: "statusRemarks",
			title: apiCalls.convertLocalLang("remarks"),
			width: 280,
			filter: true,
		},
	];
	...
	SwapColmns = [
		...
		},
		{
			...
			title: apiCalls.convertLocalLang("FromWallet"),
			filter: true,
		},
		{
			field: "toWalletCode",
			title: apiCalls.convertLocalLang("ToWallet"),
			width: 170,
			filter: true,
		},
		{
			field: "fromValue",
			title: apiCalls.convertLocalLang("FromValue"),
			width: 180,
			filter: true,
			dataType: "number",
			filterType: "numeric",
		...
		{
			field: "toValue",
			title: apiCalls.convertLocalLang("ToValue"),
			width: 140,
			filter: true,
			dataType: "number",
			filterType: "numeric",
		...
		{
			field: "totalAmount",
			title: apiCalls.convertLocalLang("TotalAmount"),
			width: 180,
			filter: true,
			dataType: "number",
			filterType: "numeric",
		...
		{
			field: "amountInUsd",
			title: apiCalls.convertLocalLang("AmountInUsd"),
			width: 150,
			filter: true,
			dataType: "number",
			filterType: "numeric",
	...
	BuySellColmns = [
		...
		{
			field: "type",
			title: apiCalls.convertLocalLang("Type"),
			filter: true,
			width: 190,
		},
		{
		...
		{
			field: "beforeValue",
			title: apiCalls.convertLocalLang("BeforeValue"),
			width: 200,
			filter: true,
			dataType: "number",
			filterType: "numeric",
		...
		{
			field: "afterValue",
			title: apiCalls.convertLocalLang("AfterValue"),
			width: 200,
			filter: true,
			dataType: "number",
			filterType: "numeric",
	...
	depositCryptoColomns = [
		...
		{
			field: "coinName",
			title: apiCalls.convertLocalLang("coinName"),
			filter: true,
			width: 180,
		},
		{
		...
		},
		{
			...
			title: apiCalls.convertLocalLang("walletAddress"),
			filter: true,
			width: 400,
		},
		{
			...
			<>
				<Drawer
					title={[
						<div className="side-drawer-header">
							<Translate
								...
								component={Title}
								className="fs-26 fw-400 mb-0 text-white-30"
							/>
					...
					<div className="transaction-tabs">
						<Tabs
							className="crypto-list-tabs mt-0"
							...
							<TabPane
								...
								tab={
									<Translate
										content="All"
										component={Tabs.TabPane.tab}
										className="custom-font fw-400 fs-14"
									/>
								}>
										...
										<Collapse onChange={collapseGrids} className="mb-16">
											<Panel
												header={
													<Translate
														content="BuyandSell"
														component={Collapse.Panel.header}
														className="custom-font fw-400 fs-14 text-white"
													/>
												}
												key="1">
												{this.state.activeTab === "1" && (
													<HistoryGridComponent
														columns={this.BuySellColmns}
														gridUrl={BuySellURL}
														params={{
                      ...
                      {this.state.activeTab === '1' && <HistoryGridComponent columns={this.SwapColmns} gridUrl={SwapURL} params={{ memberId: this.props.member?.id }}></HistoryGridComponent>}
										...
										<Collapse onChange={collapseGrids} className="mb-16">
											<Panel
												...
												{this.state.activeTab === "1" && (
													<HistoryGridComponent
														columns={this.depositCryptoColomns}
														gridUrl={DepositCryptoURL}
														params={{
															memberId: this.props.member?.id,
														}}></HistoryGridComponent>
												)}
										...
										<Collapse onChange={collapseGrids} className="mb-16">
											<Panel
												...
												{this.state.activeTab === "1" && (
													<HistoryGridComponent
														columns={this.withdrwCryptoColomns}
														gridUrl={WithdrawCryptoURL}
														params={{
															memberId: this.props.member?.id,
														}}></HistoryGridComponent>
												)}
