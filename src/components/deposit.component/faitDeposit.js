...
class FaitDeposit extends Component {
  ...
  handleshowTab = async (tabKey) => {
    ...
    if (tabKey === 1) {
      apicalls.trackEvent({
        "Type": 'User', "Action": 'Deposit Fiat page view', "Username": this.props.member.userName, "MemeberId": this.props.member.id, "Feature": 'Deposit Fiat', "Remarks": 'Deposit page view', "Duration": 1, "Url": window.location.href, "FullFeatureName": 'Deposit Fiat'
      });
