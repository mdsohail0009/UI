        ...
        if (this.state.isTermsAgreed) {
            ...
            if (response.ok) {
                ...
                appInsights.trackEvent({
                    name: 'Buy', properties: {"Type": 'User',"Action": 'Page view',"Username": this.props?.member.email,"MemeberId": this.props?.member.id,"Feature": 'Buy',"Remarks": 'Buy coins',"Duration": 1,"Url": window.location.href,"FullFeatureName": 'Buy'}
                });
            } else {
