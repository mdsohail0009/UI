        ...
        return (
            <>
                ...
                {this.props.buySell.tabKey === 1 && !this.props.isTab ? <>
                    <Translate content="buy_your_crypto_for_cash_text" component={Paragraph} className="text-white-30 fw-600 fs-18 mt-16 text-left" />
                    ...
                    <Translate content="sell_your_crypto_for_cash_text" component={Paragraph} className="text-white-30 fw-600 fs-18 mt-16" />
                    <SellToggle /></>
                }
            </>
        )
