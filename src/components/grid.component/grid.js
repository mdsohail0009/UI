                    ...
                    {this.props.showExcelExport && <div className='text-right'> <button
                        ...
                        onClick={() => {
                            const getCombineFieldValue = (dataItem, fields) => {
                                // return dataItem[fields[0]] && dataItem[fields[1]] ? `${dataItem[fields[0]].debit ?this.numberWithCommas(dataItem[fields[0]]):dataItem[fields[0]]} / ${dataItem[fields[0]].credit?this.numberWithCommas(dataItem[fields[1]]):dataItem[fields[1]]}` : (dataItem[fields[0]] || dataItem[fields[1]]);
