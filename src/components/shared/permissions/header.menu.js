...
class HeaderPermissionMenu extends Component {
    ...
    render() {
        ...
        const { send_crypto, send_fiat, reaceive_crypto, receive_fiat } = this.state.drawerMenu
        return <>
            <Menu
                theme="light"
                mode="horizontal"
            ...
            <SendReceive
                showDrawer={send_crypto || send_fiat || receive_fiat || reaceive_crypto}
