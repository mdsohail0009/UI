    ...
    render() {
        ...
        return (
          <div className="portfolio-list">
            ...
            />
            <Currency prefix={"$"} defaultValue={totalCryptoValue} suffixText={"BTC"} className={`text-white-30 fs-16 m-0 ${totalCryptoValue < 0 ? 'text-red' : 'text-green'}`} style={{ lineHeight: '18px' }} />
