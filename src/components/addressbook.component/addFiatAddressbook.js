        ...
        >
          ...
          <Form.Item>
            <div className="d-flex">
              ...
              />{" "}
              <span
                style={{ color: "var(--textWhite30)", paddingLeft: "2px" }}
              ></span>
            </div>
            <Input
              className="cust-input"
            ...
            //   }}
              ...
              placeholder={userConfig?.isBusiness
                ? "Business Name"
                : "Recipient full name"}
              disabled={true}
            />
          ...
          <Form.Item
            ...
            label={
              <Translate content="Recipient_address1" component={Form.label} />
            }
            required
            rules={[
              {
