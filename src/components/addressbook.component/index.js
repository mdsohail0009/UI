...
//import success from '../withdraw.crypto.component/success';
    ...
    return (
      <>
        <div className="box basic-info">
          ...
          <Paragraph className="basic-decs mb-16">
            <Translate
              content="address_book_tag"
              component={Paragraph}
              className="basic-decs mb-16"
            />
          </Paragraph>
          ...
          <div className="display-flex mb-16">
            ...
            >
              ...
              <li onClick={this.statusUpdate}>
                <Tooltip
                  placement="topRight"
                  title={<Translate content="active_inactive" />}
                >
          ...
          </div>
          {
            ...
            //     />
            //   </div>
            warning(apiCalls.convertLocalLang('one_record'))
            )
            // warning(apiCalls.convertLocalLang('one_record'))
          }
          {this.state.successMsg && (
             success('Record ' + (this.state.selectedObj.status == 'Active' ? 'deactivated' : 'activated') + ' successfully')
            // <Alert
            //   type="success"
            //   description={
            //     "Record " +
