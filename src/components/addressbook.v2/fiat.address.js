    ...
    renderStep = (step) => {
        ...
        const steps = {
                    ...
                    <Row gutter={24} className=" text-white mt-36">
                        ...
                        <Col xs={24} sm={24} md={24} lg={24} xxl={24}>
                            <div className="pay-list py-4" style={{ alignItems: 'baseline' }}>
                                ...
                                <Title className="fs-14 text-white fw-500  text-right plist-textwrap">{this.state.reviewDetails?.favouriteName}</Title>
                            </div>
                        </Col>
            ...
            successpage: <div className="custom-declaraton"> <div className="success-pop text-center declaration-content">
                ...
                <Title level={2} className="success-title">Your transaction has been processed successfully</Title>
