    ...
    render() {
        ...
        return (
            <>
                ...
                <Translate className="fs-12 text-white-30 text-center mt-16 mb-36" content="summary_hint_text" component={Paragraph} />
                <Translate size="large" block className="pop-btn" onClick={() => this.props.changeStep('confirm')} content="confirm_swap" component={Button} />
            </>
        )
    }
}
