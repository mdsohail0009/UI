          ...
          <div>
           ...
           {this.state.selectedTab != 2 && <Col xs={24} md={24} lg={24} xl={24} xxl={24}  className="search-space">
            ...
            {(!this.state.loading) && <>
                ...
                <ul style={{ listStyle: 'none', paddingLeft: 0, }} className="addCryptoList adbook-scroll mobile-scroll">
                ...
                <ul style={{ listStyle: 'none', paddingLeft: 0, }} className="addCryptoList adbook-scroll paste-recept-style mobile-scroll">
