        ...
        return (
            <>
                <div className="success-pop text-center">
                    ...
                    <Paragraph className="fs-14 text-white-30 fw-200">Your order has been placed successfully, {cd.totalValue} {cd.walletCode} amount will be added into your wallet.</Paragraph>
                    {/* <Translate content="success_msg" component={Title} className="text-white-30 fs-36 fw-200 mb-4" />
