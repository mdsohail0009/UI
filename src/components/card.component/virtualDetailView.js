...
render() {
    return (<>
                ...
                <Row gutter={24} className='mb-16'>
                        <Col span={12}>
                                <div className="d-flex align-start">
                                    <div style={{width:'12px',height:'12px',borderRadius:'50%',backgroundColor:'rgb(82 196 26)',marginTop:'5px'}}></div>
                        ...
                        <Col span={12}>
                                <div className="d-flex align-start">
                                <div style={{width:'12px',height:'12px',borderRadius:'50%',backgroundColor:'rgb(24 144 255)',marginTop:'5px'}}></div>
                                   <div className='l-height-normal'>
            ...
            <Col span={24}>
                    <div className="virtual-box p-24 coin-details right">
