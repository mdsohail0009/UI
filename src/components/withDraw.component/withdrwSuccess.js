    ...
    return (
        <>
            <div className="success-pop text-center mb-24">
                ...
                <Paragraph className="fs-14 text-white-30 fw-200">Your order has been placed successfully, {fd.totalValue} {fd.walletCode} amount has been debited from your wallet.</Paragraph>
