...
class ProfileInfo extends Component {
  ...
  fileDownload = async () => {
    if (!this.props?.userConfig?.isKYC) {
      ...
      this.setState({ ...this.state, Loader: false, errorMessage: this.props?.userConfig?.customerState==="Under Review"?"Your account is under review":"Your account approval is in progress state" });
    }
    else {
