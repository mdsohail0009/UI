        ...
        return (
            <div>
                ...
                <div className="crypto-address">
                    ...
                    <div className="mb-0 fw-500 text-white-30 walletadrs">{this.props?.sendReceive?.depositWallet?.walletAddress}  <CopyToClipboard text={this.props?.sendReceive?.depositWallet?.walletAddress}>
